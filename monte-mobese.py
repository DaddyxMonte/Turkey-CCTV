...
while True:
    try:
        secim = input(Fore.RED+'Secim:'+Style.RESET_ALL)
        if secim == "1":
            print('Bakimda')
        elif secim == "2":
            print(Fore.CYAN+'[ 1 ] Bostanlı Köprü\n[ 2 ] Bostanlı Cami\n[ 3 ] Şair Eşref Bulvarı\n[ 4 ] Cumhuriyet Meydanı\n[ 5 ] Tekel Meydanı\n[ 6 ] Çankaya\n[ 7 ] Varyant\n[ 8 ] Güzelyalı\n[ 9 ] Küçükyalı\n[ 10 ] Karataş\n[ 11 ] Göztepe\n[ 12 ] Gaziemir Migros\n[ 13 ] Gaziemir Kipa Kavşağı\n[ 14 ] Marina Kavşağı\n[ 15 ] Mustafa Kemal Sahil Bulvarı\n[ 16 ] Karya Evleri\n[ 17 ] Gündogdu Meydanı\n[ 18 ] Demirköprü\n[ 19 ] Kahramanlar Kapısı\n[ 20 ] Buca Üçkuyular Meydanı\n[ 21 ] Uçanyol\n[ 22 ] Alsancak Gar\n[ 23 ] Karşıyaka Atatürk Anıtı\n[ 24 ] Seyrek Köprü\n[ 25 ] Konak Pier\n[ 26 ] Konak Diş Hastanesi\n[ 27 ] Şirinyer Koşu Yolu\n[ 28 ] Vakıflar Kavşağı\n[ 29 ] Montrö Meydanı\n[ 30 ] Yeşildere Caddesi\n[ 31 ] Adnan Kahveci Köprüsü\n[ 32 ] İkiçeşmelik\n[ 33 ] Meslek Fabrikası\n[ 34 ] Yeni Girne Kavşağı\n[ 35 ] Şemikler\n[ 36 ] Mavişehir Giriş\n[ 37 ] Atakent Kavşağı\n[ 38 ] Çiğli İtfaiye\n[ 39 ] Ekol Hastanesi\n[ 40 ] Egekent\n[ 41 ] Ata Sanayi Girişi\n[ 42 ] Serbest Bölge\n[ 43 ] Mürselpaşa Bulvarı\n[ 44 ] Basmane Kavşağı\n[ 45 ] Karşıyaka Naldöken Köprüsü\n[ 46 ] Zübeyde Hanım Kavşağı\n[ 47 ] Soğukkuyu Kavşağı\n[ 48 ] İzmir Arena\n[ 49 ] Bahçelerarası Köprü\n[ 50 ] Balçova Kipa\n[ 51 ] Maltepe Askeri Lisesi\n[ 52 ] Narlıdere Otoban\n[ 53 ] Narlıdere Folkart\n[ 54 ] Ege-Park Kavşağı\n[ 55 ] Bahçelerarası\n[ 56 ] Mirhatpaşa Endüstri Meslek\n[ 57 ] Fahrettin Altay Kavşağı\n[ 58 ] Denizmen Kavşağı\n[ 59 ] Hıfzısıhha Kavşağı\n[ 60 ] İslam Enstitüsü\n[ 61 ] Yeşilyurt Kavşağı\n[ 62 ] Üçyol Kavşağı\n[ 63 ] Gümrük Borsa\n[ 64 ] Tınaztepe Kavşağı\n[ 65 ] Çevikbir Meydanı\n[ 66 ] Köstence Köprüsü Kavşağı\n[ 67 ] Buca Heykel Kavşağı\n[ 68 ] Şirinyer Tapu\n[ 69 ] Yeşillik Caddesi | Buca Ayrımı\n[ 70 ] Eşrefpaşa\n[ 71 ] Melez Deltası\n[ 72 ] Bornova Hükümet Konağı\n[ 73 ] Bornova Stadyum Kavşağı\n[ 74 ] Migros Kavşağı\n[ 75 ] Otogar Kavşağı'+Style.RESET_ALL)
            cctv = input('Secim: ')
            secilenkamera = izmirsehir[cctv]
            webbrowser.open_new_tab(secilenkamera)
            os.system('cls')
            sleep(1)
            banner()
    except:
        (print('Dogru Secim Yap'))